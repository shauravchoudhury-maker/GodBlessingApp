...
var REQUIREMENTS = [
  ...
  { id: "D4",  area: "data", gate: "now", status: "partial", check: "live",
    ...
    evidence: "2026-09-12: retention-worker.js written (60 days; blanks note, removes replies and thread, keeps the numbers). NOT deployed — RETENTION_SETUP.txt. Met when stats/retention shows a run." },
  { id: "D5",  area: "data", gate: "now", status: "partial", check: "live",
    text: "The holder of a request link can delete their request and its replies.",
    evidence: "2026-09-12: built — owner key in the link, sha256 hash in the document, rules check the hash on the erase update; replies and thread deletable only after. Met when the rules are republished and a fresh request is erased on the live site." },
