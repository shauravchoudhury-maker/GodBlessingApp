...
var REQUIREMENTS = [
  ...
  { id: "A4",  area: "abuse", gate: "now", status: "open",    check: "live",
    text: "A billing budget alert is set on the Firebase project so a runaway bill is noticed the same day.",
    evidence: "Google Cloud → Billing → Budgets. Not set." },
  { id: "A5",  area: "abuse", gate: "now", status: "open",    check: "live",
    text: "Firebase App Check is enforced on Firestore so scripts without a real browser cannot write.",
    evidence: "Not enabled. Needs reCAPTCHA Enterprise or Turnstile provider and the SDK call in blessing.html." },
  ...
  { id: "S2",  area: "security", gate: "now", status: "open",    check: "human",
    text: "Every admin Google account has 2-step verification on.",
    evidence: "Founder to confirm." },
  { id: "S3",  area: "security", gate: "now", status: "open",    check: "human",
    text: "The Firebase project owner is a separate account from the daily admin account, with a recovery method on file.",
    evidence: "Not done." },
  ...
  { id: "S5",  area: "security", gate: "now", status: "partial", check: "code",
    ...
    evidence: "One service account; scope it to guides + applications read when the second worker exists." },
  ...
  { id: "D3",  area: "data", gate: "now", status: "open",    check: "live",
    text: "Firestore is exported to a bucket on a schedule and point-in-time recovery is on.",
    evidence: "No backup exists. One console mis-click loses the guide list." },
  { id: "D4",  area: "data", gate: "now", status: "open",    check: "code",
    ...
    evidence: "Not built. Needs a scheduled worker with the service account." },
  { id: "D5",  area: "data", gate: "now", status: "open",    check: "code",
    text: "The holder of a request link can delete their request and its replies.",
    evidence: "Not built." },
  { id: "D6",  area: "data", gate: "now", status: "open",    check: "human",
  ...
  { id: "L1",  area: "legal", gate: "now", status: "open",    check: "human",
    ...
    evidence: "None published; the 18+ attestation and 'what a guide does' text exist in-app." },
  { id: "L2",  area: "legal", gate: "now", status: "open",    check: "human",
    text: "A written safeguarding policy names a safeguarding lead and an incident process.",
    evidence: "None written. Institutions and charity registration will ask." },
